...
void GsmModem::init(const QString& name, int baudrate)
{
    ...
    if(initializing_ == false)
    {
        ...
        QTimer::singleShot( 12000,this,SLOT(onModemInitTimeout()) );
        initializing_ = true;
        init_pos_ = 0;
        init_list_<<"AT"
                 ...
                 <<"ATS0=0"     // Запрет автоответа
                 <<"AT+CNMI=1,1,0,0,1" //Включение оповещения о входящих смс
